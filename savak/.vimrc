...
set smarttab                    "Makes tabing smarter, it realize you have 2 vs 4
...
"running c code using openmp
map <F2> :! gcc  % -Wall -Wextra -Wshadow  -fopenmp && ./a.out <CR>
map <F3> :! gcc  % -Wall -Wextra -Wshadow  && ./a.out <CR>

"activate rainbow bracket
let g:rainbow_active = 1
let g:startify_center = 1

"to remove all comments with '//' in c
map <leader>/ :%s/\/\///g<CR>
